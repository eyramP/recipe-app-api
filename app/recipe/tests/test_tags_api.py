...
class PublicTagsAPITest(TestCase):
    ...
    def test_auth_required(self):
        """Test auth required for receiving tags."""
...
class PrivateTagsAPITest(TestCase):
    ...
    def test_tags_limited_to_authenticated_user(self):
        """Test list of tags is limited to authticated user."""
    ...
    def test_filter_assgined_to_recipies(self):
    ...
    def test_filtered_tagss_unique(self):
        """"Test filtered tags retuns a unique list."""
        tag = Tag.objects.create(user=self.user, name='Breakfast')
